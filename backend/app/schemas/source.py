...
class GoogleSheetsSourceCreateRequest(BaseModel):
    name: str = Field(min_length=1, max_length=255)
    # Can be either: 
    # 1. Direct URL: https://docs.google.com/spreadsheets/d/{id}/edit#gid={gid}
    # 2. Spreadsheet ID only (if sheet_url is not provided)
    sheet_url: str | None = Field(default=None, max_length=1000)
    spreadsheet_id: str | None = Field(default=None, min_length=1, max_length=255)
    sheet_gid: str | None = Field(default=None, min_length=1, max_length=50)
